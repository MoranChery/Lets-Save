...
to_run = [
    ...
    (celery_init, f'/Users/{pc_user}/Desktop/Project_Lets_Improve/Lets_Improve/server/'),
    (celery_beat, f'/Users/{pc_user}/Desktop/Project_Lets_Improve/Lets_Improve/server/'),
]
